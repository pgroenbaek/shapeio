...
It allows you to make any kind of edit to a shape file. The module does not provide any safeguards, so edits may result in invalid shape files that cannot be used with Open Rails or MSTS.
